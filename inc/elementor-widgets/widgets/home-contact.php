...
/**
 *
 * Hostza elementor home contact section widget.
 *
 * @since 1.0
 */
class Hostza_Home_Contact extends Widget_Base {

	public function get_name() {
		return 'hostza-home-contact-section';
	}

	public function get_title() {
		return __( 'Home Contact', 'hostza-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Home Contact Section', 'hostza-companion' ),
            ]
        );
        $this->add_control(
            'bg_img',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Right Section Content', 'hostza-companion' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'How to Find Us', 'hostza-companion' ),
            ]
        );
        ...
        $this->add_control(
            'contact_contents', [
                ...
                'fields' => [
                    [
                        'name' => 'item_icon',
                        'label' => __( 'Item Icon', 'hostza-companion' ),
                        'label_block' => true,
                    ...
                    [
                        ...
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Location', 'hostza-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        ...
                        'default' => __( '200, A-block, Green road, USA', 'hostza-companion' ),
                    ],
                ],
                'default'   => [
                    [      
                        'item_icon'  => __( 'flaticon-placeholder', 'hostza-companion' ),
                        'item_title' => __( 'Location', 'hostza-companion' ),
                        'item_text'  => __( '200, A-block, Green road, USA', 'hostza-companion' ),
                    ],
                    [      
                        'item_icon'  => __( 'flaticon-phone-call', 'hostza-companion' ),
                        'item_title' => __( 'Call Us', 'hostza-companion' ),
                        'item_text'  => __( '+10 378 478 2789', 'hostza-companion' ),
                    ],
                    [      
                        'item_icon'  => __( 'flaticon-paper-plane', 'hostza-companion' ),
                        'item_title' => __( 'Mail Us', 'hostza-companion' ),
                        'item_text'  => __( 'contact@hostzashop.com', 'hostza-companion' ),
                    ],
                ]
            ]
        );      
        ...
        $this->start_controls_section(
            'home_contact_sec_style', [
                'label' => __( 'Home Contact Section Styles', 'hostza-companion' ),
        ...
        $this->add_control(
			'btn_hvr_border_bg_col', [
				'label' => __( 'Button Hover Border & Bg Color', 'hostza-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
    ...
    <!-- find_us_area start -->
    <div class="find_us_area find_bg_1" <?php echo hostza_inline_bg_img( esc_url( $bg_img ) ); ?>>
        <div class="container">
            <div class="row">
