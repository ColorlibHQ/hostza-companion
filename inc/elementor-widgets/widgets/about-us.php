...
/**
 *
 * Hostza elementor about us section widget.
 *
 * @since 1.0
 */
class Hostza_About_Us extends Widget_Base {

	public function get_name() {
		return 'hostza-aboutus';
	}

	public function get_title() {
		return __( 'About Us', 'hostza-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'about_left_content',
            [
                'label' => __( 'About Left Content', 'hostza-companion' ),
            ]
        );
        $this->add_control(
            'left_img',
            [
                'label' => esc_html__( 'Left Image', 'hostza-companion' ),
        ...
        $this->add_control(
            'left_icon',
            [
                'label' => esc_html__( 'Select an Icon', 'hostza-companion' ),
        ...
        $this->add_control(
            'big_txt',
            [
                'label' => esc_html__( 'Big Text', 'hostza-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Opening Hour', 'hostza-companion' ),
            ]
        );
        $this->add_control(
            'day_hour',
            [
                'label' => esc_html__( 'Day and Hour', 'hostza-companion' ),
        ...
        $this->start_controls_section(
            'about_right_content',
            [
                'label' => __( 'About Right Content', 'hostza-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'About Us', 'hostza-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'default'   => 'Experienced and <br>Traditional Stylish <br>Hostza Shop',
            ]
        );
        $this->add_control(
            'sec_text',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Learn More', 'hostza-companion' ),
            ]
        );
        $this->add_control(
            'btn_url',
        ...
        $this->start_controls_section(
            'about_sec_style', [
                'label' => __( 'About Section Styles', 'hostza-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Left Section Styles', 'hostza-companion' ),
        ...
        $this->add_control(
			'exp_val_col', [
				'label' => __( 'Experience Value Color', 'hostza-companion' ),
        ...
        $this->add_control(
			'exp_txt_col', [
				'label' => __( 'Experience Text Color', 'hostza-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Right Section Styles', 'hostza-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        ...
        $this->add_control(
            'sec_title_col', [
                'label' => __( 'Sec Title Color', 'hostza-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'sec_text_col', [
                'label' => __( 'Sec Text Color', 'hostza-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'list_circle_col', [
                'label' => __( 'List Item Circle Color', 'hostza-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'btn_txt_col', [
                'label' => __( 'Button Text & Border Color', 'hostza-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    $left_img       = !empty( $settings['left_img']['id'] ) ? wp_get_attachment_image( $settings['left_img']['id'], 'hostza_about_img_588x600', '', array( 'alt' => 'about image' ) ) : '';
