 ...
 * @since 1.0
 */
class Hostza_Team_Members extends Widget_Base {

	public function get_name() {
		return 'hostza-team-members';
	}

	public function get_title() {
		return __( 'Team Members', 'hostza-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'team_member_content',
			[
				'label' => __( 'Team Member content', 'hostza-companion' ),
			]
        );
        $this->add_control(
            'sec_icon',
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default' => esc_html__( 'Our Cutter Masters', 'hostza-companion' )
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Team Member Items', 'hostza-companion' ),
		...
		$this->add_control(
            'team_members', [
                ...
                'fields' => [
                    [
                        'name' => 'member_img',
                        'label' => __( 'Member Image', 'hostza-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'member_name',
                        'label' => __( 'Member Name', 'hostza-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Lallu Mia', 'hostza-companion' ),
                    ],
                    [
                        'name' => 'member_designation',
                        'label' => __( 'Member Designation', 'hostza-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Design Expert', 'hostza-companion' ),
                    ],
                    [
                        'name' => 'social_info_separator',
                        'label' => __( 'Social Links', 'hostza-companion' ),
                        'type' => Controls_Manager::HEADING,
                        'separator' => 'after'
                    ],
                    [
                        'name' => 'fb_url',
                        'label' => __( 'Facebook Profile URL', 'hostza-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'tw_url',
                        'label' => __( 'Twitter Profile URL', 'hostza-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::URL,
                        'default' => [
                            'url' => '#'
                    ...
                    [
                        'name' => 'ins_url',
                        'label' => __( 'Instagram Profile URL', 'hostza-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::URL,
                        'default' => [
                            'url' => '#'
                ...
                'default'   => [
                    [      
                        ...
                        'member_name'     => __( 'Macau Wilium', 'hostza-companion' ),
                        'member_designation'     => __( 'Massage Master', 'hostza-companion' ),
                        'fb_url'     => '#',
                        'tw_url'     => '#',
                        'ins_url'     => '#',
                    ],
                    [      
                        ...
                        'member_name'     => __( 'Dan Jacky', 'hostza-companion' ),
                        'member_designation'     => __( 'Mens Cut', 'hostza-companion' ),
                        'fb_url'     => '#',
                        'tw_url'     => '#',
                        'ins_url'     => '#',
                    ],
                    [      
                        ...
                        'member_name'     => __( 'Luka Luka', 'hostza-companion' ),
                        'member_designation'     => __( 'Mens Cut', 'hostza-companion' ),
                        'fb_url'     => '#',
                        'tw_url'     => '#',
                        'ins_url'     => '#',
                    ...
                    [      
                        ...
                        'member_name'     => __( 'Rona Dana', 'hostza-companion' ),
                        'member_designation'     => __( 'Ladies Cut', 'hostza-companion' ),
                        'fb_url'     => '#',
                        'tw_url'     => '#',
                        'ins_url'     => '#',
                    ],
            ...
            <div class="row">
                ...
                if( is_array( $team_members ) && count( $team_members ) > 0 ) {
                    foreach( $team_members as $member ) {
                        ...
                        $member_img         = !empty( $member['member_img']['id'] ) ? wp_get_attachment_image( $member['member_img']['id'], 'hostza_team_thumb_264x320', '', array( 'alt' => $member_name.' image' ) ) : '';
