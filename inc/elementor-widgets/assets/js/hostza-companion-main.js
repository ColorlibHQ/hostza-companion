/**
 * Hostza Companion widgets, front end, without jQuery: carousels, the
...
(function () {
    ...
    function run() {
        ...
        // imagesLoaded) on .hostza-portfolio, but only when those jQuery
        ...
        // MC Scripts
        if (document.querySelector('.hostza-subscribe-newsletter-area')) {
