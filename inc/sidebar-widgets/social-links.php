...
class Hostza_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Hostza ] Social Links', 'hostza-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'hostza-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'hostza-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'hostza-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'hostza-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'hostza-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'hostza-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'hostza-companion'); ?></label>
...
} // Class hostza_social_links ends here


// Register and load the widget
function hostza_social_links_widget_load() {
	register_widget( 'Hostza_social_links' );
}
add_action( 'widgets_init', 'hostza_social_links_widget_load' );