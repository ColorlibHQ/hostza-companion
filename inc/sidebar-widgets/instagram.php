...
----------------------------------------*/
class hostza_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('hostza_instagram_photo',esc_html__('[ Hostza ] Intagram Photo','hostza-companion'),array(
			'description' => esc_html__('Hostza Instagram Photo Widget','hostza-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'hostza-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'hostza-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'hostza-companion'); ?></label>
...
if(!function_exists('hostza_instagram_widgets')):
	function hostza_instagram_widgets(){
		register_widget('hostza_instagram_photo');
	}
	add_action('widgets_init','hostza_instagram_widgets');
endif;
